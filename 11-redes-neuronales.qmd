...
|---|---|---|
| Presentación en PDF | Síntesis del capítulo para lectura o exposición. | [Abrir PDF](recursos/capitulo-12/capitulo-12-redes-neuronales-presentacion.pdf){target="_blank"} |
| Presentación editable | Diapositivas en PowerPoint. | [Descargar PPTX](recursos/capitulo-12/capitulo-12-redes-neuronales-presentacion.pptx) |
| Infografía | Resumen visual del capítulo. | [Abrir infografía](recursos/capitulo-12/capitulo-12-redes-neuronales-infografia.png){target="_blank"} |

::: {.content-visible when-format="html"}

![Infografía del capítulo 12](recursos/capitulo-12/capitulo-12-redes-neuronales-infografia.png){fig-alt="Capítulo 12. Redes neuronales artificiales" width="85%"}
