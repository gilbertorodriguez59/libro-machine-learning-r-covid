...
% Tipografías robustas para TeX Live/TinyTeX.
% Latin Modern forma parte del ecosistema estándar de LaTeX y evita
% depender de fuentes del sistema operativo del runner de GitHub Actions.
