...
ui <- fluidPage(
  ...
  sidebarLayout(
    sidebarPanel(
      ...
      radioButtons("observada", "Evidencia observada",
...
server <- function(input, output, session) {
  posterior <- reactive({
    ...
    num0 <- p0 * l0
    evidencia <- num1 + num0
    c(Clase_0 = num0 / evidencia, Clase_1 = num1 / evidencia)
  })
...
title="Capítulo 11. Clasificador Naive Bayes"
allowfullscreen
    frameborder="0"
...
[**Abrir este capítulo en Google Colab**](https://colab.research.google.com/github/gilbertorodriguez59/libro-machine-learning-r-covid/blob/main/colab/11-naive-bayes.ipynb){target="_blank"}
...
|---|---|---|
| Presentación en PDF | Síntesis del capítulo para lectura o exposición. | [Abrir PDF](recursos/capitulo-11/capitulo-11-naive-bayes-presentacion.pdf){target="_blank"} |
...
| Infografía | Resumen visual del capítulo. | [Abrir infografía](recursos/capitulo-11/capitulo-11-naive-bayes-infografia.png){target="_blank"} |

::: {.content-visible when-format="html"}

![Infografía del capítulo 11](recursos/capitulo-11/capitulo-11-naive-bayes-infografia.png){fig-alt="Capítulo 11. Clasificador Naive Bayes" width="85%"}
