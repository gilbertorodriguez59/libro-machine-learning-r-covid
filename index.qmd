...
Libro abierto con código en **R**, datos reales, videos, presentaciones,
infografías, Google Colab y laboratorios que se ejecutan directamente en el
navegador.
...
[Cuaderno Google Colab](00-cuaderno-google-colab.qmd){.btn .btn-outline-primary .btn-lg}
...
**13 capítulos · R reproducible · Datos abiertos · Videos · Shinylive · PDF**
...
- [Abrir el cuaderno en Google Colab](https://colab.research.google.com/github/gilbertorodriguez59/libro-machine-learning-r-covid/blob/main/Aprendizaje_y_Clasificacion_Automatica_con_R_Colab.ipynb)
...
El libro cuenta con una lista oficial de reproducción en YouTube, donde se
reúnen el video de presentación y los videos complementarios de cada capítulo.
...
<div class="playlist-card">
  <div>
    <strong>Lista oficial del curso</strong><br>
    Presentación general y videos complementarios de los capítulos.
  </div>
  <div>
    <a href="https://www.youtube.com/playlist?list=PLDJYd2v7Kt-Q" target="_blank" class="btn btn-danger">Abrir curso en YouTube</a>
  </div>
</div>
:::
...
Los ejemplos aplicados utilizan información de la Estadística de Accidentes de Tránsito Terrestre en Zonas Urbanas y Suburbanas del INEGI [@inegi_atus_2024] y una base educativa preparada a partir de los cierres históricos de COVID-19 de la Secretaría de Salud de México. Cuando una tabla o gráfica se elabora con estos datos, se indica la fuente y se distingue el procesamiento realizado por el autor.
